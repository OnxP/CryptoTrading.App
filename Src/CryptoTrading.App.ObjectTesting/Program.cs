...
dic.Add(
    new ExchangeCandlestick("", "TEST", CandleInterval.Minute_15, openDateTime, new DateTime(2021, 09, 10, 10, 15, 00),
        0.1m, 0.2m, 0.1m, 0.15m, 10, 0m, 10, 10, 10));

openDateTime = new DateTime(2021, 09, 10, 10, 15, 00);
dic.Add(
    new ExchangeCandlestick("", "TEST", CandleInterval.Minute_15, openDateTime, new DateTime(2021, 09, 10, 10, 30, 00),
        0.1m, 0.2m, 0.1m, 0.15m, 10, 0m, 10, 10, 10));

openDateTime = new DateTime(2021, 09, 10, 10, 30, 00);
dic.Add(
    new ExchangeCandlestick("", "TEST", CandleInterval.Minute_15, openDateTime, new DateTime(2021, 09, 10, 10, 45, 00),
        0.1m, 0.2m, 0.1m, 0.15m, 10, 0m, 10, 10, 10));

openDateTime = new DateTime(2021, 09, 10, 10, 45, 00);
dic.Add(
    new ExchangeCandlestick("", "TEST", CandleInterval.Minute_15, openDateTime, new DateTime(2021, 09, 10, 11, 00, 00),
        0.1m, 0.2m, 0.1m, 0.15m, 10, 0m, 10, 10, 10));
