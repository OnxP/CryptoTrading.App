...
namespace CryptoTrading.App.Algorithm
{
    public class MultiTimeFrameAlgorithm : IAlgorithm
    {
        ...
        {
            _symbol = symbol;
            marketData.InitialDataLoadSubscribe(symbol.Ticker, CandleInterval.Hour_4, ProcessHistoricMarketDataHigh);
            marketData.InitialDataStreamSubscribe(symbol.Ticker, CandleInterval.Hour_4, ProcessLiveCandleStickHigh);
