...
namespace Tulip
{
    ...
    {
        private static int VoloStart(double[] options) => (int)options[1] - 1;

        private static int VoloStart(decimal[] options) => (int)options[1] - 1;

        private static int Volo(int size, double[][] inputs, double[] options, double[][] outputs)
        {
        ...
        private static int Volo(int size, decimal[][] inputs, decimal[] options, decimal[][] outputs)
        {
            int shortPeriod = (int)options[0];
            int longPeriod = (int)options[1];
